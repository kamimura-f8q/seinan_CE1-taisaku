...
const LESSONS = [
  ...
  // ================================================================
  {
    ...
    // ------ 単語 ------
    vocabulary: [
      { en: "travel",     ja: "旅行する",           example: "I ___ by Shinkansen from Osaka to Tokyo.",           exampleAnswer: "traveled" },
      { en: "window",     ja: "窓",                 example: "From the ___, I enjoyed many wonderful views.",       exampleAnswer: "window" },
      { en: "wonderful",  ja: "すばらしい",          example: "From the window, I enjoyed many ___ views.",         exampleAnswer: "wonderful" },
      { en: "view",       ja: "景色",               example: "From the window, I enjoyed many wonderful ___.",      exampleAnswer: "views" },
      { en: "tower",      ja: "塔",                 example: "In Kyoto, I saw the five-story ___, Gojunoto.",      exampleAnswer: "tower" },
      { en: "castle",     ja: "城",                 example: "On the way to Nagoya, there was a ___.",             exampleAnswer: "castle" },
      { en: "check",      ja: "～を確認する",        example: "I ___ the map and found it was Kiyosu Castle.",      exampleAnswer: "checked" },
      { en: "map",        ja: "地図",               example: "I checked the ___ to find the name of the castle.",  exampleAnswer: "map" },
      { en: "also",       ja: "～もまた，さらに",    example: "I ___ saw Mt. Fuji in Shizuoka.",                   exampleAnswer: "also" },
      { en: "beautiful",  ja: "美しい",             example: "Mt. Fuji was so ___!",                               exampleAnswer: "beautiful" },
      { en: "turn",       ja: "順番",               example: "Now it's your ___.",                                exampleAnswer: "turn" },
      { en: "experience", ja: "経験",               example: "Tell us about your ___ during vacation.",            exampleAnswer: "experience" },
      { en: "vacation",   ja: "休暇，休み",          example: "Tell us about your experiences during ___.",         exampleAnswer: "vacation" },
    ],
  ...
  // ================================================================
  {
    ...
    // ------ 単語 ------
    vocabulary: [
      { en: "children",   ja: "子どもたち",         example: "___ are climbing up a tree with a ladder.",        exampleAnswer: "Children" },
      { en: "climb",      ja: "～に登る",           example: "Children are ___ing up a tree with a ladder.",     exampleAnswer: "climbing" },
      { en: "ladder",     ja: "はしご",             example: "Children are climbing up a tree with a ___.",      exampleAnswer: "ladder" },
      { en: "broccoli",   ja: "ブロッコリー",        example: "Wait, it's not a tree. It's ___!",                 exampleAnswer: "broccoli" },
      { en: "dictionary", ja: "辞書",               example: "No, the runners are on a ___!",                    exampleAnswer: "dictionary" },
      { en: "creative",   ja: "創造的な",           example: "Tanaka Tatsuya made these ___ miniature artworks.", exampleAnswer: "creative" },
      { en: "miniature",  ja: "ミニチュアの",        example: "He made these creative ___ artworks.",             exampleAnswer: "miniature" },
      { en: "artwork",    ja: "芸術作品",           example: "He made these creative miniature ___.",            exampleAnswer: "artworks" },
      { en: "everyday",   ja: "日常の，ありふれた",  example: "He uses ___ objects in unique ways.",              exampleAnswer: "everyday" },
      { en: "object",     ja: "物",                 example: "He uses everyday ___ in unique ways.",             exampleAnswer: "objects" },
      { en: "unique",     ja: "独特の",             example: "He uses everyday objects in ___ ways.",            exampleAnswer: "unique" },
      { en: "feel",       ja: "～と感じる",          example: "He ___ happy when he comes up with good ideas.",  exampleAnswer: "feels" },
      { en: "idea",       ja: "考え，アイデア",      example: "He feels happy when he comes up with good ___.",  exampleAnswer: "ideas" },
    ],
  ...
  // ================================================================
  {
    ...
    // ------ 単語 ------
    vocabulary: [
      { en: "popular",       ja: "人気のある",             example: "Onigiri is ___ abroad.",                              exampleAnswer: "popular" },
      { en: "abroad",        ja: "外国で，海外で",          example: "Onigiri, a rice ball, is popular ___.",               exampleAnswer: "abroad" },
      { en: "even",          ja: "～でさえ",               example: "You can find onigiri shops in the US, France, and ___ Israel!", exampleAnswer: "even" },
      { en: "appeal",        ja: "興味を引く，人気を得る",   example: "Why does onigiri ___ to people overseas?",            exampleAnswer: "appeal" },
      { en: "overseas",      ja: "海外で，外国の",          example: "Why does onigiri appeal to people ___?",              exampleAnswer: "overseas" },
      { en: "handy",         ja: "手軽な",                 example: "It is a ___ and healthy fast food.",                  exampleAnswer: "handy" },
      { en: "healthy",       ja: "健康によい",             example: "It is a handy and ___ fast food.",                    exampleAnswer: "healthy" },
      { en: "addition",      ja: "追加；in addition＝さらに", example: "In ___, they can enjoy a variety of fillings.",      exampleAnswer: "addition" },
      { en: "variety",       ja: "種類；a variety of＝さまざまな", example: "They can enjoy a ___ of fillings.",            exampleAnswer: "variety" },
      { en: "filling",       ja: "中身，具",               example: "They can enjoy a variety of ___.",                    exampleAnswer: "fillings" },
      { en: "local",         ja: "地元の",                 example: "They may put their ___ food in it.",                  exampleAnswer: "local" },
      { en: "favorite",      ja: "お気に入りの",            example: "Some people see onigiri in their ___ anime.",         exampleAnswer: "favorite" },
      { en: "international", ja: "国際的な",               example: "Today, onigiri is an ___ food.",                      exampleAnswer: "international" },
    ],
